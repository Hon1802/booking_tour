// content Mail
export const contentEmail = ( customerName?: string, requestID?: string, confirmationDate?:Date,  ) =>{
    const testHTML = `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                ...
                <div class="content">
                    ...
                    <p>Chúng tôi xin lỗi khi phải thông báo rằng yêu cầu của bạn đã được huỷ bỏ. Dưới đây là thông tin chi tiết:</p>
                    <ul>
